"""
TrafficGeneratorExponential
Generate synthetic network traffic with exponential inter-packet times.
"""
...
class TrafficGeneratorExponential(TrafficGenerator, traffic_type='exponential'):
