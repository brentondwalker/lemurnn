...
def main():
    ...
    dag_data_dir = "/home/brenton/PycharmProjects/lemurnn/emulab/seq1014-exponentialTx-run2"

    link_properties = link_properties_library[link_properties_str]

    trace_generator = TraceGeneratorDagData(link_properties, normalize=normalize, datadir=dag_data_dir)
