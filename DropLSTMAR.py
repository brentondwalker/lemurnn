...
class DropLSTMAR(LinkEmuModelAR):
    def __init__(self, input_size=4, hidden_size=2, num_layers=1, learning_rate=0.001, loadpath=None, dropout_rate=0.0, use_deltas=False):
        self.model_name = f"droplstm_ar{'d' if use_deltas else ''}"
    ...
    def forward_deltas(self, x, hidden=None, ar_x=None, teacher_forcing_ratio=0.0):
        ...
        for t in range(seq_len):
            ...
            if use_teacher_forcing:
                ...
                prev_cumulative = ar_x[:, t:t + 1, 1:2]
            else:
    ...
    def forward_std(self, x, hidden=None, ar_x=None, teacher_forcing_ratio=0.0):
        batch_size, seq_len, _ = x.size()
        device = x.device
